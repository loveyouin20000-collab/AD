"""Hermetic fixtures for B2-05C3 V3 DLCM contract tests."""
...
V4_CONTRACT_TEMPLATE: dict[str, Any] = {
    "schema_version": "b2_dlcm_uniform_relative_contract_v4",
    "contract_stage": "b2_05c3a",
...
def contract_config(**overrides: Any) -> dict[str, Any]:
    payload = dict(V4_CONTRACT_TEMPLATE)
