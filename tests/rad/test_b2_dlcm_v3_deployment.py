...
from rad.phase_b import b2_dlcm_v3_deployment as deployment
...
def test_inference_forbids_aux_api() -> None:
    ...
    wrap = deployment.ImmutableV3DLCMInference(trunk)
    with pytest.raises(deployment.B2DLCMV3DeploymentError):
...
def test_h_deploy_pins_v3_architecture() -> None:
    ...
    assert v3.ARCHITECTURE_CONTRACT_VERSION == "b2_dlcm_architecture_v3"
