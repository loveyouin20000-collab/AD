...
from tests.rad.b2_dlcm_v4_fixtures import contract_config
...
def test_dual_dry_run_permutation_stable() -> None:
    ...
    a = training.dry_run_complete_v4_contract_validation(
        config=cfg_a, seed=17, output_dir="/tmp/v3-closure-a"
    )
    b = training.dry_run_complete_v4_contract_validation(
