#!/usr/bin/env python3
"""Adopt untouched C1 final roster for V5 (no reselection)."""
...
from rad.phase_b import b2_dlcm_v5_roster_adoption as adoption  # noqa: E402


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Adopt C1 final roster for V5.")
    parser.add_argument("--repo-root", default=str(_REPO_ROOT))
    parser.add_argument(
        "--output",
        default=str(_REPO_ROOT / "docs/phase_b/b2_05c4_final_roster_adoption_manifest.json"),
    )
...
if __name__ == "__main__":
    ...
    except (adoption.B2DLCMV5RosterAdoptionError, protocol.B2DLCMV5ProtocolError) as exc:
