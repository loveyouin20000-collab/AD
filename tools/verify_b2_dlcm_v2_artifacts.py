#!/usr/bin/env python3
"""Verify B2 DLCM V2 artifact receipts and schemas."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Verify B2 DLCM V2 artifacts.")
    parser.add_argument("--artifact", action="append", default=[])
    parser.add_argument("--require-schema-prefix", default="b2_dlcm_v2_")
    return parser
