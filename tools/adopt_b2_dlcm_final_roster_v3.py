...
from rad.phase_b import b2_dlcm_v3_roster_adoption as adoption  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output",
        default=str(_REPO_ROOT / "docs/phase_b/b2_05c2_final_roster_adoption_manifest.json"),
    )
...
if __name__ == "__main__":
    ...
    except (adoption.B2DLCMV3RosterAdoptionError, protocol.B2DLCMV3ProtocolError) as exc:
